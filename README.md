...
🔗 Live Demo
https://house-price-predictor182.streamlit.app
---
 Project Overview
Item	Detail
...
---
Steps Followed
Data Cleaning — null handling, one-hot encoding, dropping high-null columns
EDA & Correlation Analysis — Pearson correlation, feature selection (|corr| ≥ 0.5)
Outlier Removal — IQR method on SalePrice
Feature Engineering — 12 new features created:
...
Train / Val / Test Split — 60% / 20% / 20% (no data leakage)
Model Training & Hyperparameter Tuning — GridSearchCV (cv=5) on all models
Bias/Variance Analysis — Learning curves for XGBoost & Random Forest
Optimized Ensemble — scipy minimize to find mathematically optimal weights
